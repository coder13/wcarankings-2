...
if (!applicationUrl && !adminUrl) {
  ...
  test("activates and rolls back a real candidate schema, including a partial group", async () => {
    ...
    await insertState(schemas.production, {
      ...
      capabilities: { core: true, resultRankings: true, competitionRankings: true, personCompetitionRankings: true, cityEventStats: true, sumOfRanks: true, yearlyPersonRankings: true },
      artifactId: 9,
