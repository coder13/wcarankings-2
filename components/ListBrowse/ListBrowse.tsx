  ...
  return (
    <div className="app">
      ...
      <main className="listBrowse">
        ...
        ) : error ? <p className="listBrowseEmpty" role="alert">Could not load public lists. Please refresh and try again.</p> : <p className="listBrowseEmpty">No public lists match “{query}”.</p>}
        {filtered.length > 50 && (
