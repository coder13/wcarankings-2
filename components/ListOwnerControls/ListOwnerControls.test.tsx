...
test("renders the list creation and owner actions", () => {
  const markup = renderToStaticMarkup(<><ListCreateTrigger /><ListOwnerControls listId="7K3M9Q2D" initialVisibility="public" /><ListMembershipRequestRows listId="7K3M9Q2D" initialRequests={[{ id: 1, name: "Ethan Davis", personId: "2016DAVI02" }]} /></>);
