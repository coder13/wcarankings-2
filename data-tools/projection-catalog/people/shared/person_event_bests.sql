...
ADD INDEX idx_person_event_bests_rank (
  period_year,
  event_id,
  result_type,
  result_value,
...
ADD INDEX idx_person_event_bests_country (
  period_year,
  event_id,
  result_type,
  country_id,
...
ADD INDEX idx_person_event_bests_scope (
  period_year,
  country_id,
  result_type,
  event_id,
...
ADD INDEX idx_person_event_bests_continent_scope (
  period_year,
  continent_id,
  result_type,
  event_id,
