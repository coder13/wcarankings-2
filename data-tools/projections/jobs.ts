...
export const PROJECTION_JOBS: readonly ProjectionJob[] = [
  ...
  { id: "result-facts", dependencies: ["raw-wca"], sqlFiles: ["result_facts.sql"], tables: ["result_facts"], releaseGroup: "result-facts", releaseOrder: 1, releaseSchemaVersion: 2, estimatedDurationMs: 150_000, enabledByDefault: true },
  { id: "sum-of-ranks", dependencies: ["result-facts"], sqlFiles: ["person_sum_of_ranks_scores.sql"], tables: ["person_sum_of_ranks_scores"], releaseGroup: "sum-of-ranks", releaseOrder: 6, releaseSchemaVersion: 2, estimatedDurationMs: 180_000, enabledByDefault: true, subject: "people", stat: "sum-of-ranks" },
  { id: "competition-podium-members", dependencies: [], sqlFiles: ["competition_podium_members.sql"], tables: ["competition_podium_members"], releaseGroup: "competition-rankings", releaseOrder: 3, releaseSchemaVersion: 1, estimatedDurationMs: 30_000, enabledByDefault: true, subject: "competitions", stat: "podium-members" },
  { id: "competition-event-stats", dependencies: ["competition-podium-members"], sqlFiles: ["competition_event_stats.sql"], tables: ["competition_event_stats"], releaseGroup: "competition-rankings", releaseSchemaVersion: 1, estimatedDurationMs: 90_000, enabledByDefault: true, subject: "competitions", stat: "event-stats" },
  { id: "competition-stats", dependencies: [], sqlFiles: ["competition_stats.sql"], tables: ["competition_stats"], releaseGroup: "competition-rankings", releaseSchemaVersion: 1, estimatedDurationMs: 30_000, enabledByDefault: true, subject: "competitions", stat: "stats" },
  { id: "result-rankings", dependencies: ["result-facts"], sqlFiles: ["result_rankings_single.sql", "result_rankings_average.sql", "result_gender_rankings_single.sql", "result_gender_rankings_average.sql"], tables: ["result_rankings_single", "result_rankings_average", "result_gender_rankings_single", "result_gender_rankings_average"], releaseGroup: "result-rankings", releaseOrder: 2, releaseSchemaVersion: 2, estimatedDurationMs: 150_000, enabledByDefault: true, subject: "people", stat: "result-rankings" },
  { id: "result-ranking-counts", dependencies: ["result-rankings"], sqlFiles: ["result_ranking_counts.sql", "result_gender_ranking_counts.sql"], tables: ["result_ranking_counts", "result_gender_ranking_counts"], releaseGroup: "result-rankings", releaseSchemaVersion: 2, estimatedDurationMs: 15_000, enabledByDefault: true, subject: "people", stat: "result-ranking-counts" },
  { id: "person-event-rankings", dependencies: ["result-facts"], sqlFiles: ["person_event_rankings.sql"], tables: ["person_event_rankings"], releaseGroup: "person-event-rankings", releaseSchemaVersion: 1, estimatedDurationMs: 90_000, publish: false, subject: "people", stat: "event-rankings" },
  { id: "person-year-rankings", dependencies: ["result-facts"], sqlFiles: ["person_year_ranking_cohorts.sql", "person_year_rankings_single.sql", "person_year_rankings_average.sql", "person_year_ranking_counts.sql"], tables: ["person_year_ranking_cohorts", "person_year_rankings_single", "person_year_rankings_average", "person_year_ranking_counts"], releaseGroup: "yearly-person-rankings", releaseOrder: 7, releaseSchemaVersion: 1, estimatedDurationMs: 150_000, enabledByDefault: true, subject: "people", stat: "year-rankings" },
  { id: "person-ranking-counts", dependencies: ["person-event-rankings"], sqlFiles: ["projection_counts.sql"], tables: ["person_ranking_counts"], releaseGroup: "person-event-rankings", releaseSchemaVersion: 1, estimatedDurationMs: 15_000, publish: false, subject: "people", stat: "ranking-counts" },
  { id: "person-metric-values", dependencies: ["person-event-rankings"], sqlFiles: ["person_metric_values.sql"], tables: ["person_metric_values"], releaseGroup: "person-event-rankings", releaseSchemaVersion: 1, estimatedDurationMs: 90_000, publish: false, subject: "people", stat: "metric-values" },
  { id: "person-metric-scores", dependencies: ["person-metric-values"], sqlFiles: ["person_metric_scores.sql"], tables: ["person_metric_scores", "person_metric_counts"], releaseGroup: "person-event-rankings", releaseSchemaVersion: 1, estimatedDurationMs: 45_000, publish: false, subject: "people", stat: "metric-scores" },
  { id: "person-competition-rankings", dependencies: ["result-facts"], sqlFiles: ["person_competition_rankings.sql"], tables: ["person_competition_counts", "person_competition_rankings", "person_competition_ranking_counts"], releaseGroup: "person-competition-rankings", releaseOrder: 4, releaseSchemaVersion: 2, estimatedDurationMs: 90_000, enabledByDefault: true, subject: "people", stat: "competition-rankings" },
  { id: "city-event-stats", dependencies: ["result-facts"], sqlFiles: ["city_event_stats.sql"], tables: ["city_event_stats"], releaseGroup: "city-rankings", releaseOrder: 5, releaseSchemaVersion: 2, estimatedDurationMs: 90_000 },
  { id: "entity-ranking-counts", dependencies: ["competition-event-stats", "competition-stats", "city-event-stats"], sqlFiles: ["entity_ranking_counts.sql"], tables: ["entity_ranking_counts"], releaseGroup: "city-rankings", releaseSchemaVersion: 2, estimatedDurationMs: 15_000 },
] as const;
