...
export const PROJECTION_JOBS: readonly ProjectionJob[] = [
  ...
  },
  {
    ...
    dependencies: [],
    sqlFiles: ["competition_podium_members.sql"],
  ...
  },
  {
    ...
    sqlFiles: ["competition_event_stats.sql"],
  ...
  },
  {
    ...
    dependencies: [],
    sqlFiles: ["competition_stats.sql"],
  ...
  },
  {
    ...
    sqlFiles: [
      ...
      "result_gender_rankings_single.sql",
      "result_gender_rankings_average.sql",
    ],
    tables: [
  ...
  },
  {
    ...
    sqlFiles: ["result_ranking_counts.sql", "result_gender_ranking_counts.sql"],
  ...
  },
  {
    ...
    dependencies: ["result-facts"],
    sqlFiles: ["person_event_rankings.sql"],
  ...
  },
  {
    ...
    sqlFiles: ["projection_counts.sql"],
  ...
  },
  {
    ...
    dependencies: ["person-event-rankings"],
    sqlFiles: ["person_metric_values.sql"],
  ...
  },
  {
    ...
    sqlFiles: ["person_metric_scores.sql"],
  ...
  },
  {
    ...
    sqlFiles: ["entity_ranking_counts.sql"],
