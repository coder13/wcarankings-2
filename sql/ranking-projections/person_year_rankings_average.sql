...
SELECT
  candidate.ranking_year AS year,
  candidate.event_id,
  cohort.cohort_id,
  candidate.person_id,
  candidate.result_id,
...
FROM
  cohort_candidates candidate
  JOIN person_year_ranking_cohorts cohort ON cohort.scope = candidate.scope
