...
ALTER TABLE ranking_entries ADD INDEX idx_ranking_entries_gender_world_best (event_id, gender, best, person_id);
ALTER TABLE ranking_entries ADD INDEX idx_ranking_entries_gender_continent_best (event_id, continent_id, gender, best, person_id);
ALTER TABLE ranking_entries ADD INDEX idx_ranking_entries_gender_country_best (event_id, country_id, gender, best, person_id);
