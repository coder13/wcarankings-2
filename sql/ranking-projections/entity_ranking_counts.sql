...
FROM city_event_stats WHERE gender = 'all' AND fastest_single IS NOT NULL GROUP BY event_id
UNION ALL
SELECT 'city', event_id, 'average', COUNT(*)
FROM city_event_stats WHERE gender = 'all' AND fastest_average IS NOT NULL GROUP BY event_id
UNION ALL
