...
FROM benchmark_solve_facts solve;
...
ALTER TABLE benchmark_issue_179_single_common
  ...
  ADD INDEX idx_benchmark_issue179_common_continent (gender, event_id, continent_id, continent_position),
  ADD INDEX idx_benchmark_issue179_common_search (gender, person_id, event_id, world_position, result_id, attempt_number);
