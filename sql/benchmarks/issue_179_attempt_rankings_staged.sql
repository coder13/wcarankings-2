...
ALTER TABLE benchmark_issue_179_single_regional
  ...
  ADD INDEX idx_benchmark_issue179_staged_continent (gender, event_id, continent_id, continent_position),
  ADD INDEX idx_benchmark_issue179_staged_country (gender, event_id, country_id, country_position),
  ADD INDEX idx_benchmark_issue179_staged_search (gender, person_id, event_id, world_position, result_id, attempt_number);
